      ...
      <header className="border-b border-[#C0C0C0]/20">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span
              className={`text-sm tracking-[0.2em] uppercase text-[#C0C0C0]/70 ${lato.className}`}
            >
              Local City Places
            </span>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="scrollbar-x-site scrollbar-x-silver flex items-center justify-center gap-1 sm:gap-2 overflow-x-auto py-2">
            {aboutStory && (
              <a
                href="#story"
                className={`px-3 py-2 text-xs tracking-[0.15em] uppercase text-[#C0C0C0]/60 hover:text-[#C0C0C0] transition-all ${lato.className}`}
              >
                Story
              </a>
            )}
            ...
            {phone && (
              ...
              >
                ...
                <div>
                  ...
                  <p className={`font-medium ${lato.className}`}>
            ...
            {(fullAddress || location) && (
              ...
              >
                ...
                <div>
                  ...
                  <p
                    className={`font-medium whitespace-nowrap ${lato.className}`}
                  >
      ...
      <div className="relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
                ...
                <div className="relative">
                  ...
                  <div className="relative w-32 h-32 rounded-full bg-gradient-to-b from-[#1a1a1a] to-[#0d0d0d] border-4 border-[#C0C0C0]/50 flex items-center justify-center overflow-hidden shadow-2xl">
                    {logoUrl ? (
                      ...
                      <span
                        className={`text-4xl text-[#C0C0C0] ${cinzel.className}`}
                      >
                        {initials}
                      </span>
                    )}
              ...
              {categoryName && (
                <div className="mb-4">
                  <span
                    className={`inline-flex items-center gap-2 px-4 py-1 bg-gradient-to-r from-[#71706E] to-[#C0C0C0] text-black text-sm tracking-widest uppercase ${lato.className}`}
                  >
              ...
              {/* Business Name */}
              <h1
                className={`text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight bg-gradient-to-b from-[#FFFFFF] via-[#C0C0C0] to-[#71706E] bg-clip-text text-transparent ${cinzel.className}`}
              >
                {businessName}
              </h1>
              ...
              {description && (
                <p
                  className={`text-lg text-[#E8E8E8]/70 leading-relaxed max-w-lg mx-auto lg:mx-0 mb-10 ${lato.className}`}
                >
                  {description}
                </p>
              )}
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                {phone && (
                  <a
                    href={`tel:${phone}`}
                    className={`inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-[#71706E] to-[#C0C0C0] text-black font-semibold hover:opacity-90 transition-opacity cursor-pointer ${cinzel.className}`}
                  >
                ...
                {website && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`inline-flex items-center justify-center gap-3 px-8 py-4 border-2 border-[#C0C0C0]/50 text-[#C0C0C0] hover:bg-[#C0C0C0]/10 transition-colors cursor-pointer ${cinzel.className}`}
                  >
                ...
                <div className="relative">
                  ...
                  <div className="absolute -left-6 top-0 bottom-0 w-4 flex flex-col justify-around py-4">
                    {[...Array(12)].map((_, i) => (
                      <div
                        key={i}
                        className="w-3 h-4 bg-[#C0C0C0]/30 rounded-sm"
                      />
                    ))}
                  </div>
                  ...
                  {/* Video container */}
                  <div
                    className="relative w-[280px] sm:w-[320px] border-4 border-[#C0C0C0]/60 bg-black overflow-hidden shadow-2xl"
                  ...
                  <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 text-center">
                    <p
                      className={`text-[10px] tracking-[0.3em] uppercase text-[#C0C0C0]/70 ${lato.className}`}
                    >
                      Now Showing
                    </p>
                  </div>
        ...
        {aboutStory && (
          <div id="story" className="max-w-6xl mx-auto px-4 py-12 scroll-mt-16">
            <h2
              className={`text-3xl text-[#C0C0C0] text-center mb-8 ${cinzel.className}`}
            >
              Our Story
            </h2>
            <div className="border border-[#C0C0C0]/20 p-8 bg-gradient-to-b from-[#1a1a1a]/50 to-transparent rounded-lg">
              <p
                className={`text-lg text-[#E8E8E8]/80 leading-relaxed whitespace-pre-line ${lato.className}`}
              >
                {aboutStory}
              </p>
            </div>
        ...
        {hours && Object.values(hours).some(Boolean) && (
          <div id="hours" className="max-w-6xl mx-auto px-4 py-12 scroll-mt-16">
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <h2 className={`text-3xl text-[#C0C0C0] ${cinzel.className}`}>
                Hours
              </h2>
            </div>
            <div className="grid sm:grid-cols-2 gap-4 border border-[#C0C0C0]/20 p-8 bg-gradient-to-b from-[#1a1a1a]/50 to-transparent rounded-lg">
              {[
                ...
                <div
                  key={day}
                  className="flex justify-between py-2 border-b border-[#C0C0C0]/10 last:border-0"
                >
                  <span className={`text-[#C0C0C0] ${lato.className}`}>
                    {day}
                  </span>
                  <span className={`text-[#E8E8E8]/70 ${lato.className}`}>
                    {value || "Closed"}
                  </span>
                </div>
              ))}
        ...
        >
          ...
          {fullAddress && (
            <p
              className={`text-center text-[#E8E8E8]/70 mb-6 ${lato.className}`}
            >
              {fullAddress}
            </p>
          )}
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((service, idx) => (
                <div
                  key={idx}
                  className="border border-[#C0C0C0]/20 p-6 bg-gradient-to-b from-[#1a1a1a]/50 to-transparent rounded-lg hover:border-[#C0C0C0]/40 transition-colors"
                >
                  <div className="flex justify-between items-start mb-2">
                    <h3
                      className={`text-xl text-[#C0C0C0] ${cinzel.className}`}
                    >
                      {service.name}
                    </h3>
                    {service.price && (
                  ...
                  {service.description && (
                    <p className={`text-[#E8E8E8]/60 ${lato.className}`}>
                      {service.description}
                    </p>
                  )}
                </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {photos.map((photo, idx) => (
                <div
                  key={idx}
                  className="aspect-square border border-[#C0C0C0]/20 overflow-hidden rounded-lg group"
                >
                  <img
                    src={photo}
        ...
        <div id="reviews" className="max-w-6xl mx-auto px-4 py-12 scroll-mt-16">
          ...
          <div className="border border-[#C0C0C0]/20 p-12 text-center bg-gradient-to-b from-[#1a1a1a]/50 to-transparent rounded-lg">
            ...
            <p className={`text-[#E8E8E8]/50 ${lato.className}`}>
              No reviews yet
            </p>
            <p className={`text-[#E8E8E8]/30 text-sm ${lato.className}`}>
        ...
        {(instagramUrl || facebookUrl || tiktokUrl) && (
          <div className="border-t border-[#C0C0C0]/20 py-8">
            <div className="flex items-center justify-center gap-6">
              <span className={`text-[#E8E8E8]/50 ${lato.className}`}>
                Follow Us
              </span>
              {instagramUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 border border-[#C0C0C0]/30 rounded-full flex items-center justify-center hover:bg-[#C0C0C0]/10 transition-all"
                >
        ...
        <footer className="border-t border-[#C0C0C0]/20 py-6">
          <p
            className={`text-center text-xs text-[#E8E8E8]/30 tracking-widest uppercase ${lato.className}`}
          >
            © Local City Places
          </p>
        </footer>
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:hidden z-50 bg-[#0d0d0d]/95 border-t border-[#C0C0C0]/30 p-4">
        <div className="flex gap-3">
          {phone && (
            <a
              href={`tel:${phone}`}
              className="flex-1 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-[#71706E] to-[#C0C0C0] text-black font-medium rounded"
            >
          ...
          {website && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 py-3 border border-[#C0C0C0]/50 text-[#C0C0C0] rounded"
            >
