...
function generateMerchantWelcomePreview(params: {
  ...
  return emailShell(
    ...
    <p style="color:#334155;line-height:1.6;">Oh and don't forget to start listening to KLCP Radio because your radio spot and your Signature Soundtracks have already started playing on there.</p>
